...
./gameserver -gip 127.0.0.1 -seq replay -r 30 -d 1 -m 4000 -b 50 -t 2000 -h 600 0</dev/null 1>/dev/null 2>/dev/null  & 
popd >/dev/null
...
./call   127.0.0.1 6000 127.0.0.1 6001 1111 0</dev/null 1>/dev/null 2>/dev/null &
...
./random   127.0.0.1 6000 127.0.0.5 6005 5555 0</dev/null 1>/dev/null 2>/dev/null &
./raise1 127.0.0.1 6000 127.0.0.6 6006 6666 0</dev/null 1>/dev/null 2>/dev/null &
./raise100   127.0.0.1 6000 127.0.0.7 6007 7777 0</dev/null 1>/dev/null 2>/dev/null &

echo "start your game"
./game 127.0.0.1 6000 127.0.0.8 6008 8888 0
